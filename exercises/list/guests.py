...
print("You will be at my wedding, just as you were every moment of my life, " + guests[2])
...
print("That human stupidity does not prevent you from going to my wedding, " + guests[1])
...
print("I just learned that the guest table was not successful in its purchase, so I will only to invite two people.")
